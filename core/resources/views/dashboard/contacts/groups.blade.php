            ...
            <div class=" hover">
                <div class="row-inner"><br>
                    <div class="nav nav-pills nav-stacked m-t-sm">
                        <div class="row-row">
                            <div class="col-sm-9 p-a-0">
                                ...
                                <ul class="list">
                                    ...
                                    ?>
                                    <li class="marginBottom5"><a href="{{ route('contacts') }}" {!! $group_id == '' ? " style='font-weight: bold;color:#976737'" : '' !!}>
                                            {{ __('backend.allContacts') }}
                                    ...
                                    @foreach ($ContactsGroups as $ContactsGroup)
                                        <li class="marginBottom5"
                                            ...
                                            <a href="{{ route('contacts', ['group_id' => $ContactsGroup->id]) }}"
                                                {!! $ContactsGroup->id == $group_id ? " style='font-weight: bold;color:#976737'" : '' !!}> {!! $ContactsGroup->name !!}

                                                <small>({{ count($ContactsGroup->contacts) }})</small>

                                            </a>

                                            <div id="grpRow{{ $ContactsGroup->id }}" class="pull-right displayNone">
                                    ...
                                    <li class="marginBottom5"><a {!! $group_id == 'wait' ? " style='font-weight: bold;color:#976737'" : '' !!}
                                            href="{{ route('contacts', ['group_id' => 'wait']) }}">
                                    ...
                                    <li>
                                        <a {!! $group_id == 'blocked' ? " style='font-weight: bold;color:#976737'" : '' !!}
                                            href="{{ route('contacts', ['group_id' => 'blocked']) }}">
                                            {{ __('backend.blockedContacts') }}
                                ...
                                <div class="p-y">
                                    @if (Session::has('EditContactsGroup'))
                                        ...
                                        <div class="input-group input-group-sm">
                                            {!! Form::text('name', Session::get('EditContactsGroup')->name, [
                        ...
                        <a href="{{ route('contacts') }}" class="btn btn-sm white btn-addon primary m-b-1"><i
