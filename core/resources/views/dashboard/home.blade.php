            ...
            <div class="row">
                ...
                <div class="{!! $r_cls !!}">
                    <div class="row">
                        ...
                        $clr_ary = ['info', 'warn', 'success', 'accent', 'primary', 'danger'];
                        $ik = 0;
                                        ...
                                        <div class="box p-a" style="cursor: pointer"
                                            ...
                                            <a href="{{ route('topics', $headerWebmasterSection->id) }}">
                                                <div class="pull-left m-r">
                                                    <i
                                                        class="material-icons  text-2x text-{{ @$clr_ary[$ik] != '' ? @$clr_ary[$ik] : 'muted' }} m-y-sm">{!! $LiIcon !!}</i>
                                                </div>
                                                <div class="clear">
                                    ...
                                    <ul class="list no-border p-b">
                                        @foreach ($Contacts as $Contact)
                                            <li class="list-item">
                                                ...
                                                <div class="list-body">
                                                    <div>
                                                        <a href="{{ route('contactsEdit', ['id' => $Contact->id]) }}">{{ $Contact->first_name }}
                                                            {{ $Contact->last_name }}</a>
                                                    </div>
