        ...
        <div class="row m-b">
            ...
            <div class="col-sm-6 text-sm-right">
                <div class="btn-group m-l-xs m-t-1">
                    ...
                    <div id="dashboard-report-range" class="btn btn-sm primary" data-placement="top"
                    ...
                    <input type="hidden" id="this_daterangepicker_start" name="this_daterangepicker_start"
...
@push('after-scripts')
    ...
    <script src="{{ asset('assets/dashboard/js/bootstrap-daterangepicker/daterangepicker.js') }}" type="text/javascript">
    </script>
                ...
                initDashboardDaterange: function() {
                    ...
                    $('#dashboard-report-range').daterangepicker({
                            ...
                            ranges: {
                                ...
                                '{{ __('backend.yesterday') }}': [moment().subtract(1, 'days'), moment()
                                    .subtract(1, 'days')
                                ],
                                '{{ __('backend.last7Days') }}': [moment().subtract(6, 'days'), moment()],
                                '{{ __('backend.last30Days') }}': [moment().subtract(29, 'days'), moment()],
                                '{{ __('backend.thisMonth') }}': [moment().startOf('month'), moment().endOf(
                                    'month')],
                                '{{ __('backend.lastMonth') }}': [moment().subtract(1, 'month').startOf(
