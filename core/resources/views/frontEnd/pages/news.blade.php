        ...
        <div class="container">
            <div class="hero-content" data-aos="fade-up">
                ...
                <p class="hero-subtitle">
                    ...
                    and event milestones of <b>FINSPHERE EXPO KUWAIT</b>.
                </p>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up">
                    <div class="news-card">
                        ...
                        <div class="news-content">
                            ...
                            <p>
                                <b>FINSPHERE EXPO KUWAIT</b> unveils top global speakers shaping the future of finance.
                            </p>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="news-card">
                        ...
                        <div class="news-content">
                            ...
                            <p>
                                Major fintech companies confirm their participation at <b>FINSPHERE EXPO KUWAIT</b>.
                            </p>
                            <a href="{{ url('/single-news') }}" class="news-link">
                                Read More <i class="fa fa-arrow-right"></i>
                            </a>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                    <div class="news-card">
                        ...
                        <div class="news-content">
                            ...
                            <p>
                                Thousands of attendees register as excitement builds for <b>FINSPHERE EXPO KUWAIT</b>.
                            </p>
                            <a href="{{ url('/single-news') }}" class="news-link">
                                Read More <i class="fa fa-arrow-right"></i>
                            </a>
